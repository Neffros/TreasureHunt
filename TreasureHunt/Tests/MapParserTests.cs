...
public class MapParserTests
{
    ...
    [TestCase("C - 7 - 2", 7, 2)]
    [TestCase("C - 8 - 8 ", 8, 8)]
    public void ShouldCreateEmptyMap_WithDimension_ReturnsSameMap(string line, int expectedWidth, int expectedHeight)
    {
    ...
    [Test]
    [TestCase(arg: new[]{""})]
    public void ShouldNotCreateMap_WhenNoLines_ThrowsInitializationMapException(string[] lines)
    {
    ...
    public void ShouldCreateMap_WithComment_IgnoresComments(string[] lines, int expectedWidth, int expectedHeight)
    {
    ...
    public void ShouldCreateMap_WithMountains_ReturnsSameMap(string[] lines, List<Mountain> expectedMountains)
    {
    ...
    public void ShouldNotCreateMap_WithMountainsWhenWrongFormat_ThrowsInitializationMapException(string[] lines)
    {
        Action createMap = () => _mapParser.CreateMap(lines);
        createMap.Should().Throw<InitializationMapException>();
    }
    ...
    public void ShouldCreateMap_WithTreasures_ReturnsSameMap(string[] lines, List<Treasure> expectedTreasures)
    {
    ...
    public void ShouldNotCreateMap_WithTreasuresWhenWrongFormat_ThrowsInitializationMapException(string[] lines)
    {
        Action createMap = () => _mapParser.CreateMap(lines);
        createMap.Should().Throw<InitializationMapException>();
    }
    ...
    public void ShouldCreateMap_WithAdventurer_ReturnsSameMap(string [] lines, List<Adventurer> expectedAdventurers)
    {
    ...
    public void ShouldNotCreateMap_WithAdventurersWhenWrongFormat_ThrowsInitializationMapException(string[] lines)
    {
    ...
    public void ShouldNotCreateMap_WithOutOfBoundsEntities_ThrowsInitializationMapException(string[] lines)
    {
        Action createMap = () => _mapParser.CreateMap(lines);
        createMap.Should().Throw<InitializationMapException>();
    }
    ...
    public void ShouldNotCreateMap_WithAdventurersWhenInvalidInstructions_ThrowsInitializationMapException(string[] lines)
    {
        Action createMap = () => _mapParser.CreateMap(lines);
        createMap.Should().Throw<InitializationMapException>();
    }
    ...
    public void ShouldNotCreateMap_MapWithEntitiesOverlapping_ThrowsInitializationMapException(string[] lines)
    {
        Action createMap = () => _mapParser.CreateMap(lines);
        createMap.Should().Throw<InitializationMapException>();
    }
    ...
    [Test]
    public void ShouldCreateMap_WithAllEntities_ReturnsSameMap()
    {
        string[] lines =
        {
            "C - 5 - 4",
